...
public class Rush
{
	...
	public static void main(String[] args)
	{
		...
		*   holds a reference to the newly instanciated ArrayList object */
		...
		System.out.println("The Percussor joins the band (robotic Neil)");
		System.out.println("https://vimeo.com/243225534");
		band.add(2, "The Percussor");

		//Iterate over the band members
		Iterator<String> it = band.iterator();
		while (it.hasNext()) {
